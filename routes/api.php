...
Route::get('/mahasiswa','App\Http\Controllers\MahasiswaController@getDataMhs');
Route::get('/mahasiswa/{nim}','App\Http\Controllers\MahasiswaController@getDataMhsByNim');
